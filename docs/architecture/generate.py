#!/usr/bin/env python
"""
Fae Architecture Generator — reads the codebase and produces:
...
<head>
<meta charset="utf-8">
<title>Fae — Architecture Explorer</title>
...
<div class="container">
  <h1>Fae <span>Architecture Explorer</span></h1>
